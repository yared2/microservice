package com.appsdeveloperblog.photoapp.api.user.ui.controllers;
...
public class UsersController {
	...
	//	userDto.setUserId("test");
		...
		CreateUserResponseModel returValue = modelMapper.map(createUser,CreateUserResponseModel.class);
